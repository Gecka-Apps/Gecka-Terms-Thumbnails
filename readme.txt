...
By default, it is enabled for your posts categories. If you want to order any other taxonomy, go read <a href="http://gecka-apps.com/wordpress-plugins/terms-thumbnails/">the plugin's page on our website</a>.

You would like to support us? Go over <a href="http://gecka-apps.com">at our website</a> and check our great premium plugins.

Want to contribute? That plugin is on <a href="https://github.com/Gecka-Apps/Gecka-Terms-Thumbnails">GitHub</a>

== Installation ==

1. Download the plugin file
2. Unzip the file into a folder on your hard drive
3. Upload `gecka-terms-thumbnails` folder to the `/wp-content/plugins/` folder on your site
