...
class Gecka_Terms_Thumbnails_Settings {
	...
	private static $defaults = array(	'term_image_max_w' => 1024,
    ...
    public function admin_init() {
		...
		add_settings_field('term_image_max_w', __('Term image max size', 'gecka-terms-thumbnails'), array($this, 'field_image_max_size'), 'media');
		...
		add_settings_field('term_thumbnail_size_w', __('Term thumbnail max size', 'gecka-terms-thumbnails'), array($this, 'field_thumbnail_max_size'), 'media');
		...
		add_settings_field('term_medium_size_w', __('Term medium thumbnail max size', 'gecka-terms-thumbnails'), array($this, 'field_medium_max_size'), 'media');
	...
	public function field_image_max_size () {
		...
		<input name="term_image_max_w" type="text" id="term_image_max_w" value="<?php esc_attr_e( $this->term_image_max_w ); ?>" class="small-text" />
		<label for="term_image_max_h"><?php _e('Max Height'); ?></label>
		<input name="term_image_max_h" type="text" id="term_image_max_h" value="<?php esc_attr_e( $this->term_image_max_h ); ?>" class="small-text" />
		<br>
		<span class="description"><?php _e('If one is set, any uploaded original term image will be proportionally resized to this max width.', 'gecka-terms-thumbnails'); ?></span>
		<?php
	...
	public function field_thumbnail_max_size () {
		...
		<input name="term_thumbnail_size_w" type="text" id="term_thumbnail_size_w" value="<?php esc_attr_e( $this->term_thumbnail_size_w ); ?>" class="small-text" />
	...
	public function field_medium_max_size () {
		...
		<input name="term_medium_size_w" type="text" id="term_medium_size_w" value="<?php esc_attr_e( $this->term_medium_size_w ); ?>" class="small-text" />
